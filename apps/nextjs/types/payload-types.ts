...
export interface Page {
  ...
  status?: ('draft' | 'published') | null;
  /**
   * Select a template for header and footer
   */
  pageTemplate?: (string | null) | PageTemplate;
  layout?:
    | (
        | {
            badge?: string | null;
        ...
        | {
            /**
             * Small text above the title (e.g. Latest Posts)
             */
            badge?: string | null;
            title?: string | null;
            subtitle?: string | null;
...
/**
 * Templates work as layout wrappers: header blocks -> page content -> footer blocks
 *
 * This interface was referenced by `Config`'s JSON-Schema
